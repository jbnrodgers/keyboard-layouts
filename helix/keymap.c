...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEDH] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    _______, _______, KC_K,    KC_H,    KC_SLSH, KC_COMM, KC_DOT,  KC_RSFT,
    KC_LCTL, KC_LGUI, NUMPAD,  NUMROW,  KC_LALT, KC_SPC,  _______, _______, KC_SPC,  NAV,     _______, MENU,    FN,      KC_PENT
  ),
  [_NUMROW] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    ...
    KC_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_RSFT,
