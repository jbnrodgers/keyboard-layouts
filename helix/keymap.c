...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, NUMPAD,  NUMROW,  KC_LALT, KC_SPC,  KC_ESC,  KC_ESC,  KC_SPC,  NAV,     _______, MENU,    FN,      KC_RCTL
  ),
  [_COLEDH] = LAYOUT(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_QUOT,
  ...
  [_NUMROW] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, _______, _______, KC_LALT, _______, _______, _______, _______, _______, _______, _______, _______, KC_RCTL 
  ),
  [_NUMPAD] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
  ...
  [_NAV] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, _______,                   _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
    _______, KC_MPRV, KC_MRWD, KC_MFFD, KC_MNXT, _______,                   _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
    KC_LSFT, _______, _______, _______, KC_MSTP, _______, _______, _______, _______, KC_H,    KC_J,    KC_K,    KC_L,    _______,
    KC_LCTL, KC_LGUI, _______, _______, KC_LALT, _______, _______, _______, _______, _______, _______, _______, _______, KC_RCTL 
  ),
  [_FN] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
